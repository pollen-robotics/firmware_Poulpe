...
impl BrushlessMotor {
    ...
    pub fn ecx22() -> Self {
        Self {
            ...
            pid_torque_flux_limit: 0x00000b82,
            pid_velocity_limit: 0x0000_7D00,
            // gearing ratios
...
impl BrushlessMotor {
    ...
    pub fn pid_torque_flux_limit(&self) -> u32 {
        self.pid_torque_flux_limit
    }
    pub fn pid_velocity_limit(&self) -> u32 {
        self.pid_velocity_limit
    }
