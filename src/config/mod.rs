    ...
    use crate::{
        ...
        sensors::{
            sensors::{AD5047Sensor, AksimSensor, I2cHallConfig, I2cHallSensor, SensorConfig}
        },
    };

    #[cfg(not(feature = "no_temperature_sensor"))]
    use crate::sensors::analog::{Orbita2dTemperatureConfig, Orbita3dTemperatureConfig, AnalogInputConfig};

    use crate::motor_control::driver::{DriverDRV8316, DriverTMC6200};

    // Ventouse A
    #[cfg(any(feature = "beta", all(feature = "orbita2d", any(feature = "gamma", feature="pvt"))))] // any beta or 2d gamma/pvt
    ...
    #[cfg(all(not(feature = "no_temperature_sensor"), feature = "orbita3d", feature = "pvt"))]
    pub type TemperatureSensingConfig = Orbita3dTemperatureConfig<p::ADC1, p::PB1, p::PC5, p::PB0>;
    #[cfg(all(not(feature = "no_temperature_sensor"), feature = "orbita3d", not(feature = "pvt")))]
    pub type TemperatureSensingConfig = AnalogInputConfig<p::ADC1, p::PB1>;
    #[cfg(all(not(feature = "no_temperature_sensor"), feature = "orbita2d",  feature = "pvt"))]
    pub type TemperatureSensingConfig = Orbita2dTemperatureConfig<p::ADC1, p::PC5, p::PB0>;
    #[cfg(all(not(feature = "no_temperature_sensor"), feature = "orbita2d", not(feature = "pvt")))]
    pub type TemperatureSensingConfig = AnalogInputConfig<p::ADC1, p::PB1>;
